...
<div class="max-w-2xl mx-auto p-8">
  <h1 class="text-3xl font-bold mb-6">Setup GitHub Integration</h1>
  
  {#if hasExistingApp}
    <div class="bg-green-50 border border-green-200 rounded-lg p-6 mb-8">
      <h2 class="text-lg font-semibold text-green-800 mb-2">GitHub App Configured</h2>
      <p class="text-green-700">Your GitHub App is already set up and ready to use.</p>
    </div>
  {:else}
    <div class="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
      <h2 class="text-lg font-semibold mb-4">Create a GitHub App</h2>
      <p class="text-gray-600 mb-6">
        To use PR Reviewer, you need to create a GitHub App for your organization or account.
      ...
      <div class="space-y-4">
        <button
          ...
          disabled={isCreating}
          class="w-full bg-gray-900 text-white py-3 rounded-lg hover:bg-gray-800 transition font-medium flex items-center justify-center gap-2"
        >
    ...
    <div class="mt-8 text-sm text-gray-500">
      <h3 class="font-medium text-gray-700 mb-2">What permissions will be requested?</h3>
...
export async function storeGitHubAppCredentials(credentials: GitHubAppCredentials) {
  ...
  await db.insert(table.githubAppConfig).values({
    id: 'default',
