...
<span 
  class="inline-flex items-center gap-1 text-xs px-2 py-0.5 rounded font-medium {config[complexity].color}"
...
<span class="inline-flex items-center gap-1 text-xs px-2 py-0.5 rounded border {config.color}">
