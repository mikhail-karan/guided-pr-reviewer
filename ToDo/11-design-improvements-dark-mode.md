...
<button
  ...
  class="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-dark-surface transition-colors cursor-pointer"
...
#### Cards
```svelte
<div class="bg-white dark:bg-dark-surface border border-gray-200 dark:border-dark-border rounded-xl shadow-soft">
  <!-- content -->
</div>
```
